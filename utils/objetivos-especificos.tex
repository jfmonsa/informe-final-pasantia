...
\newcommand\objetivoEspecificoC{Implementar un sistema transversal de observabilidad estructurada que permita diagnosticar el comportamiento del sistema en producción a través de componentes heterogéneos, soportado por infraestructura como código y notificaciones proactivas.}
...
\newcommand{\objectivoEspecificoDActividadadC}{
  Construcción de la suite de pruebas unitarias de las reglas de seguridad de Firestore con Vitest y \texttt{@firebase/rules-unit-testing} sobre la \textit{Firebase Emulator Suite}.
}
