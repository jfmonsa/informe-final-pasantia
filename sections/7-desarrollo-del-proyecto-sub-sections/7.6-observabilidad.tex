...
El impacto de este subsistema sobre la operación de la plataforma —la medición objetiva de la disponibilidad de los proveedores externos, la trazabilidad de errores por usuario y la reducción del tiempo medio de recuperación— se valora como resultado del proyecto en el \autoref{subsec:resultado-c}.
