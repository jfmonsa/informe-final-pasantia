...
La confiabilidad funcional y el blindaje de los datos están soportados por una \textit{suite} de pruebas diversificada. Un factor fundamental de esta estrategia es el uso de la Firebase Emulator Suite, que permite simular de forma local y efímera servicios en la nube como Firestore y Firebase Authentication, sin incurrir en costos ni afectar entornos reales de producción.

\begin{itemize}
  \item \textbf{Pruebas \textit{end-to-end} (E2E):} implementadas mediante el \textit{framework} Playwright, simulan el comportamiento determinista de un usuario navegando e interactuando con la interfaz gráfica del portal. Estas pruebas se ejecutan contra los emuladores locales, garantizando que flujos integrales —como el inicio de sesión, la creación de entidades o la interacción con componentes modales— operen correctamente de extremo a extremo.
