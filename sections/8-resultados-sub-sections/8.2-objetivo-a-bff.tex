...
\newcommand\resultadoBffRedCaption{Inspección del tráfico de red: las peticiones del cliente se dirigen exclusivamente al backend, sin exponer las integraciones externas. \hspace{1em}}
\begin{figure}[H]
  \centering
